...
REG_FILE = "../../data/regs/reg_05_08_24b.csv"
CIRCLE_FILE = "../../data/base_positions/base_circle_05_08_24a.csv"
TOP_FILE = "../../data/base_positions/base_top_05_08_24a.csv"
...
print(reg_pos.shape, model_truth_in_model.shape)
reg_pos_in_model, T_aurora_2_model, rmse = kinematics.rigid_align_svd(
    reg_pos, model_truth_in_model
)
...
ax.scatter(
    circle_pos_in_model[0, :], circle_pos_in_model[1, :], circle_pos_in_model[2, :]
)
