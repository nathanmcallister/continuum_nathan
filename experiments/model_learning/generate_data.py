...
if __name__ == "__main__":
    ...
    pure_container_one_seg, noisy_container_one_seg = generate_babble_data(cable_positions_one_seg, segment_stiffness_vals_one_seg, cable_stiffness_vals_one_seg, segment_lengths_one_seg, num_measurements=2**8)

    pure_container_two_seg, noisy_container_two_seg = generate_babble_data(cable_positions_two_seg, segment_stiffness_vals_two_seg, cable_stiffness_vals_two_seg, segment_lengths_two_seg, num_measurements=2**8)
